...
class AncientTower(object):
    ...
    def __init__(self, un_pos_x, un_pos_y, un_pos_z, un_height):
        ...
        for i in range(1, un_height - 1):
			...
			new_obj.location = (un_pos_x * City_UNIT_VALUE, un_pos_y * City_UNIT_VALUE, (un_pos_z + i) * City_UNIT_VALUE)
		...
		new_obj.location = (un_pos_x * City_UNIT_VALUE, un_pos_y * City_UNIT_VALUE, (un_pos_z + un_height - 1) * City_UNIT_VALUE)
