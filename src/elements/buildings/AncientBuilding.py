...
class AncientBuilding(object):
    ...
    def __init__(self, un_pos_x, un_pos_y, un_pos_z, un_size_x, un_size_y, un_height, empty, scene):
        ...
        wall_element_1 = bpy.data.objects.get('Wall Element 1')
        for z in range(0, un_height - 1):
            for x in range(un_size_x):
                
                #Wall element 1
                wall_element = bpy.data.objects.new('WallElement1.000', wall_element_1.data)    
                wall_element.location = (un_pos_x + x, un_pos_y, un_pos_z)   
                ...
                wall_element = bpy.data.objects.new('WallElement1.000', wall_element_1.data)   
                wall_element.location = (un_pos_x + x, un_pos_y + un_size_y - 1, un_pos_z)
            ...
            for y in range(un_size_y):
                ...
                wall_element = bpy.data.objects.new('WallElement1.000', wall_element_1.data)
                wall_element.location = (un_pos_x, un_pos_y + y, un_pos_z)
                ...
                wall_element = bpy.data.objects.new('WallElement1.000', wall_element_1.data)
                wall_element.location = (un_pos_x + un_size_x - 1, un_pos_y + y, un_pos_z)
        ...
        # Then the roof:
        # 4 corners:        
        roof_element_1 = bpy.data.objects.get('Roof Element 1')
        roof_element_2 = bpy.data.objects.get('Roof Element 2')
        roof_element_3 = bpy.data.objects.get('Roof Element 3')
        
        # Place Roof Element 1 at (un_pos_x, un_pos_y, un_height - 1)
        roof_element = bpy.data.objects.new('RoofElement1.000', roof_element_1.data)
        roof_element.location = (un_pos_x, un_pos_y, un_height - 1)
        ...
        roof_element = bpy.data.objects.new('RoofElement1.000', roof_element_1.data)
        roof_element.location = (un_pos_x + un_size_x - 1, un_pos_y, un_height - 1)
        ...
        roof_element = bpy.data.objects.new('RoofElement1.000', roof_element_1.data)
        roof_element.location = (un_pos_x + un_size_x - 1, un_pos_y + un_size_y - 1, un_height - 1)
        ...
        roof_element = bpy.data.objects.new('RoofElement1.000', roof_element_1.data)
        roof_element.location = (un_pos_x, un_pos_y + un_size_y - 1, un_height - 1)
        ...
        for x in range(un_size_x - 1):
            ...
            roof_element = bpy.data.objects.new('RoofElement2.000', roof_element_2.data)
            roof_element.location = (un_pos_x + 0.5 + x, un_pos_y, un_pos_z) 
            scene.objects.link(roof_element)                             
            roof_element.parent = empty                                 
        
            # Place Roof Element 2 at (un_pos_x + 0.5 + x, un_pos_y + un_size_y - 1, un_pos_z) AND rotate 180 degrees z
            roof_element = bpy.data.objects.new('RoofElement2.000', roof_element_2.data)
            roof_element.location = (un_pos_x + 0.5 + x, un_pos_y + un_size_y - 1, un_pos_z)
            roof_element.rotation_euler = (0, 0, math.pi) 
            scene.objects.link(roof_element)                             
            roof_element.parent = empty                                 
        ...
        for y in range(un_size_y - 1):
            ...
            roof_element = bpy.data.objects.new('RoofElement2.000', roof_element_2.data)
            roof_element.location = (un_pos_x, un_pos_y + 0.5 + y, un_pos_z)
            roof_element.rotation_euler = (0, 0, math.pi*1.5)
            scene.objects.link(roof_element)                             
            roof_element.parent = empty                                 
            ...
            roof_element = bpy.data.objects.new('RoofElement2.000', roof_element_2.data)
            roof_element.location = (un_pos_x + un_size_x - 1, un_pos_y + 0.5 + y, un_pos_z) 
            roof_element.rotation_euler = (0, 0, math.pi*0.5)
            scene.objects.link(roof_element)                             
            roof_element.parent = empty                                 
        ...
        for x in range(un_size_x - 1):
            for y in range(un_size_y - 1):
                ...
                roof_element = bpy.data.objects.new('RoofElement3.000', roof_element_3.data)
                roof_element.location = (un_pos_x + 0.5 + x, un_pos_y + 0.5 + y, un_pos_z)
                scene.objects.link(roof_element)                             
                roof_element.parent = empty                                 
