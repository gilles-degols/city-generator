...
class StairsBuilding(object):
    ...
    def __init__(self, un_pos_x, un_pos_y, un_pos_z, un_size_x, un_size_y):
        ...
        if fRand < 0.25:
			...
			new_obj.location = ((un_pos_x - 0.5) * City_UNIT_VALUE, (un_pos_y - 0.5) * City_UNIT_VALUE, un_pos_z * City_UNIT_VALUE)
        elif 0.25 <= fRand < 0.5:
            # Put it at (un_pos_x + un_size_x - 0.5, un_pos_y - 0.5) * City.UNIT_VALUE AND rotate 90 degrees z
            new_obj.location = ((un_pos_x + un_size_x - 0.5) * City_UNIT_VALUE, (un_pos_y - 0.5) * City_UNIT_VALUE, un_pos_z * City_UNIT_VALUE)
            ...
            new_obj.location = ((un_pos_x + un_size_x - 0.5) * City_UNIT_VALUE, (un_pos_y + un_size_y - 0.5) * City_UNIT_VALUE, un_pos_z * City_UNIT_VALUE)
			new.obj.rotation_euler = (0, 0, math.pi)
        else:
            # Put it at (un_pos_x - 0.5, un_pos_y + un_size_y - 0.5) * City.UNIT_VALUE AND rotate 270 degrees z
            new_obj.location = ((un_pos_x - 0.5) * City_UNIT_VALUE, (un_pos_y + un_size_y - 0.5) * City_UNIT_VALUE, un_pos_z * City_UNIT_VALUE)
